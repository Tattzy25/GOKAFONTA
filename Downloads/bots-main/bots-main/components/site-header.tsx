...
export function SiteHeader() {
  ...
  return (
    <header className="bg-background flex w-full items-center justify-center border-b px-4 min-h-14">
      <div className="flex h-14 w-full max-w-7xl items-center gap-2">
        <Button
